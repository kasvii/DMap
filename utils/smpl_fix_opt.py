...
sys.path.append('/scratch/cvlab/home/yiyou/models/WHAM')
...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # It is 31 keypoints where the first 17 keypoints follow the COCO configuration and the subsequent 14 keypoints follow the "common J14" configuration.
    ...
    def forward(self, 
        ...
        if cam is not None:
            joints3d = output.joints_wham_minus_off.reshape(*cam.shape[:2], -1, 3)
    ...
    def get_output(self, *args, **kwargs):
        ...
        joints_wham = vertices2joints(self.J_regressor_wham, smpl_output.vertices)
        ...
        output.joints_wham = joints_wham
        output.offset = offset
        output.joints_wham_minus_off = joints_wham - offset.unsqueeze(-2)
        return output
